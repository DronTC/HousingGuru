package com.example.housingguru.dataBase
...
class Db (val context: Context, factory: SQLiteDatabase.CursorFactory?) : SQLiteOpenHelper(context,
    "housingGuruDB", factory, 1){
